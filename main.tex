...
have identified two major risk factors that can drive populations into the doomed regime: long-term reductions in population size and increases in mutation rate   \citep{Lynch_MUTATION_1990, lyn93, Gabriel_MULLER_1993, lyn95}.  Population size could decline as a result of changes in the environment, such as, climate change, decreased food availability, and habitat loss or fragmentation.  For example, in the United Kingdom, the population sizes of 10 species of seed-eating birds have declined because of the use of herbicides and the shift from spring-sown to fall-sown cereals, both of which have reduced the availability of food for these birds \citep{new04}.  Increases in mutation rate have been observed directly in experimental populations.  For example, a population of \emph{Escherichia coli} adapting to a constant environment evolved a mutator mutation at $\sim 2.5 \times 10^4$  generations that increased mutation rate by $\sim 150$-fold \citep{bar09, wie13}.
