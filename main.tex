...
\label{fig:decay}
\figsupp[Variance.]{Variance in part C.}{\includegraphics[width=0.33\linewidth]{decay2}}\label{figsupp:sf1}
\end{figure}
...
\label{fig:valid}
\figsupp[Variance.]{Variance in parts A and B.}{\includegraphics[width=0.67\linewidth]{valid2}}\label{figsupp:sf2}
\end{figure}
