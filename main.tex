...
%
Blue circles show coefficient of variation of $T$, CV$[T]$, for the data shown in \FIG{decay}D.  Red line shows CV$[T]$ calculated numerically using \EQ{CV}.}{\includegraphics[width=0.33\linewidth]{figures/fig2s1.pdf}}\label{figsupp:sf1}
\end{figure}
