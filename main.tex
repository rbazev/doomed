...
%
Blue circles show coefficient of variation of $T$, CV$[T]$, for the data shown in \FIG{decay}D.  Red line shows CV$[T]$ calculated numerically using \EQ{CV}.}{\includegraphics[width=0.39\linewidth]{figures/fig2s1.pdf}}\label{figsupp:sf1}
%
\figdata{The code to generate these figures is in the Jupyter notebook \url{https://github.com/rbazev/doomed/blob/master/python/fig2.ipynb}.}\label{figdata:fig2a}
%
\figdata{The data to generate these figures is at \url{https://github.com/rbazev/doomed/blob/master/python/data/} (files named \texttt{fig2*}).}\label{figdata:fig2b}
\end{figure}
...
%
Blue circles show coefficient variation of $T$, CV$[T]$, for the data shown in the corresponding panel of \FIG{valid}.  Red line shows CV$[T]$ calculated numerically using \EQ{CV}.}{\includegraphics[width=0.67\linewidth]{figures/fig3s1.pdf}}\label{figsupp:sf2}
%
...
%
\textbf{(B)} Variability of extinction times shown in \textbf{(A)}. Blue circles show coefficient variation of $T$, CV$[T]$.  Red line shows CV$[T]$ calculated numerically using \EQ{CV}.}{\includegraphics[width=0.67\linewidth]{figures/fig3s2.pdf}}\label{figsupp:sf3}
%
\figdata{The code to generate these figures is in the Jupyter notebook \url{https://github.com/rbazev/doomed/blob/master/python/fig3.ipynb}.}\label{figdata:fig3a}
%
\figdata{The data to generate these figures is at \url{https://github.com/rbazev/doomed/blob/master/python/data/} (files named \texttt{fig3*}).}\label{figdata:fig3b}
\end{figure}
...
%
\textbf{(B)} Coefficient of variation of $T$, CV$[T]$, calculated numerically using \EQ{CV}.}{\includegraphics[width=0.67\linewidth]{figures/fig4s1.pdf}}\label{figsupp:sf4}
%
\figdata{The code to generate these figures is in the Jupyter notebook \url{https://github.com/rbazev/doomed/blob/master/python/fig4.ipynb}.}\label{figdata:fig4}
\end{figure}
...
\label{fig:melt}
%
\figdata{The code to generate this figure is in the Jupyter notebook \url{https://github.com/rbazev/doomed/blob/master/python/fig5.ipynb}.}\label{figdata:fig5}
\end{figure}
...
Numerical calculations and stochastic simulations of the branching process model were done using software written in Python 2.7 and available at \url{https://github.com/rbazev/doomed/blob/master/python/doomed.py}.
