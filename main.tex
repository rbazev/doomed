...
\begin{figure}[ht!]
\includegraphics[width=.67\linewidth]{figures/decay.pdf}
...
%
Blue circles show coefficient of variation of $T$, CV$[T]$, for the data shown in \FIG{decay}D.  Red line shows CV$[T]$ calculated numerically using \EQ{CV}.}{\includegraphics[width=0.33\linewidth]{figures/decay2}}\label{figsupp:sf1}
\end{figure}
...
\begin{figure}[ht!]
\includegraphics[width=\linewidth]{figures/valid.pdf}
\caption{
...
%
Blue circles show coefficient variation of $T$, CV$[T]$, for the data shown in the corresponding panel of \FIG{valid}.  Red line shows CV$[T]$ calculated numerically using \EQ{CV}.}{\includegraphics[width=0.67\linewidth]{figures/valid2}}\label{figsupp:sf2}
\end{figure}
...
%
\textbf{(B)} Coefficient of variation of $T$, CV$[T]$, calculated numerically using \EQ{CV}.}{\includegraphics[width=0.67\linewidth]{figures/heat2}}\label{figsupp:sf3}
\end{figure}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=.71\linewidth]{figures/melt.pdf}
...
For a given extinction time, the meltdown rate is positively correlated to the \textit{variability} in extinction time (\FIGSUPP[valid]{sf2} and \FIGSUPP[heat]{sf3}B).
...
Interestingly, if we compare populations with the same expected extinction time but different mutational parameters, populations undergoing faster meltdown rate have more variable extinction times than populations undergoing slower meltdown  (\FIGSUPP[heat]{sf3}).
