...
\subsection{Mutational meltdown does not explain extinction time in doomed populations}
...
%
In the first study to relax the assumption of constant population size, \citet{Lynch_MUTATION_1990} argued that Muller's ratchet generates a vicious cycle:
the Ratchet clicks, 
which causes population size to decline, 
which reduces the efficiency of natural selection,
which in turn accelerates the Ratchet.  
They proposed that this mutational meltdown causes populations to go extinct.
...
\figsupp[Shorter caption for main text.]{This is a supplementary figure's full caption, which will be used at the end of the manuscript.}{\includegraphics[width=6cm]{heat}}\label{figsupp:sf1}
\figsupp{This is another supplementary figure.}{\includegraphics[width=6cm]{heat}}
